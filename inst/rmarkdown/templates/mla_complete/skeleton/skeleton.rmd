---
title: Complete Options for rmd2mla
author: James M. Clawson
date: "`r gsub('^0', '', format(Sys.time(), '%d %B %Y'))`"
output: 
  rmd2mla::pdf_document: default
  rmd2mla::latex_document: default
  rmd2mla::mla_document: default
  rmd2mla::word_document: default
